...
- `script.js` enhances the page with project tabs, the hero particle field, section-aware navigation, reveal motion, and quick navigation. All content stays readable without it.
