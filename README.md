...
- **Ambient Glowing Orbs:** Background elements that track cursor movement for a parallax effect.
- **Dynamic Stats:** Animated count-up numbers for repositories, followers, and contributions.
...
- **Vanilla JavaScript** — `IntersectionObserver` for scroll reveals, procedural animations, and DOM manipulation.
...
1. Ensure the repository is named exactly `<your-username>.github.io` (in this case, `tanmayhutt.github.io`).
2. Push the `main` branch to GitHub.
3. GitHub Pages will automatically detect it and serve your site within seconds!

---
*Designed & Built by [Tanmay Tiwari](https://github.com/tanmayhutt)*
